...
if __name__ == "__main__":
    with TLCameraSDK() as sdk:
        ...
        with sdk.open_camera(camera_list[0]) as camera:
            ...
            print(f"Camera sensor type: {camera.camera_sensor_type}")
            print(f"Camera bit depth: {camera.bit_depth}")
            print(f"Camera image width: {camera.image_width_pixels}")
            print(f"Camera image height: {camera.image_height_pixels}")

            print(f"Camera exposure time range: {camera.exposure_time_range_us}")
            print(f"Camera gain range: {camera.gain_range}")
            print(f"Camera gain: {camera.gain}")
            print(f"Camera frames per trigger zero for unlimited: {camera.frames_per_trigger_zero_for_unlimited}")
